$(document).ready(function () {
    ...
    $('#submit').on('click', function (event) {
        ...
        var profPic = $('#pictureURL').val().trim();
        ...
        if (username.length > 1) {
            ...
            $.post('/api/friends', newFriend, function (data) {
                ...
                $('#user-iE').removeClass().addClass('user-bar').addClass(newFriend.mbtiArray[0]);
                $('#user-sN').removeClass().addClass('user-bar').addClass(newFriend.mbtiArray[1]);
                $('#user-fT').removeClass().addClass('user-bar').addClass(newFriend.mbtiArray[2]);
                $('#user-pJ').removeClass().addClass('user-bar').addClass(newFriend.mbtiArray[3]);
                $('#user-tA').removeClass().addClass('user-bar').addClass(newFriend.mbtiArray[4]);
                ...
                $('#match-iE').removeClass().addClass('match-bar').addClass(data.mbtiArray[0]);
                $('#match-sN').removeClass().addClass('match-bar').addClass(data.mbtiArray[1]);
                $('#match-fT').removeClass().addClass('match-bar').addClass(data.mbtiArray[2]);
                $('#match-pJ').removeClass().addClass('match-bar').addClass(data.mbtiArray[3]);
                $('#match-tA').removeClass().addClass('match-bar').addClass(data.mbtiArray[4]);
